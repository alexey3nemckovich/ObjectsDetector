...
string MatchAllGroupClassifier::GetName() const
{
    return "MatchAllGroupClassifier";
}


vector<ObjectIteratorList> MatchAllGroupClassifier::Classify(const ObjectsList& objects) const
{
...
ObjectIteratorList MatchAllGroupClassifier::RemoveObjectsGroup(
